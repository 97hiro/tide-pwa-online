// scrape-kyoto-coords.js
// 京都47件の座標を tsuriba.info + Google Maps で取得
// 出力: kyoto-coords.csv
...
const PREF = 'kyoto';
const PREF_ID = 26;
const BOUNDS = { latMin: 35.40, latMax: 35.80, lonMin: 134.90, lonMax: 135.50 };
...
async function main() {
  ...
  console.log(`=== 京都: ${allSpots.length} スポット ===\n`);
  ...
  fs.writeFileSync('kyoto-coords.csv', '\uFEFF' + csvLines.join('\n'), 'utf8');
