// scrape-hyogo-coords.js
// 兵庫84件の座標を tsuriba.info + Google Maps で取得
// 出力: hyogo-coords.csv
...
const PREF = 'hyogo';
const PREF_ID = 28;
const BOUNDS = { latMin: 34.17, latMax: 35.70, lonMin: 134.30, lonMax: 135.50 };
...
async function main() {
  ...
  console.log(`=== 兵庫: ${allSpots.length} スポット ===\n`);
  ...
  fs.writeFileSync('hyogo-coords.csv', '\uFEFF' + csvLines.join('\n'), 'utf8');
